...
test('It should get a set of cleaned DynamoDB items', (t) => {
  const expected = [
    {
  ...
  const response = getCleanedItems([
    {
      hostName: { S: '' },
      slotId: { S: '53ebfc40-a0c0-4240-9949-6f66d699202b' },
...
test('It should return an empty array if items are not of expected shape', (t) => {
  const expected: any = [];
