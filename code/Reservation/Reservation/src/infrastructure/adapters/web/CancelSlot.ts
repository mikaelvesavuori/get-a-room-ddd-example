...
import { CancelSlotUseCase } from '../../../application/usecases/CancelSlotUseCase';
...
export async function handler(
  ...
  try {
    MikroLog.start({
      metadataConfig: { ...metadataConfig, service: 'CancelSlot' },
      event,
      context
    });
    ...
    const dependencies = setupDependencies(metadataConfig('CancelSlot'));
